...
const Hero = () => {
  return (
   <section className="w-full min-h-screen flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-20 bg-gradient-to-br from-[#ffe7f0] via-[#f7ddff] to-[#f3f4ff] dark:bg-gray-900 py-16 gap-10 overflow-hidden">
...
>
        ...
        <h1 className="text-5xl font-extrabold text-blue-600">Manjushree</h1>
  ...
  I'm a code-loving creative who turns coffee and keyboard strokes into slick, scalable websites.  
  Currently building fun, functional apps with React, Tailwind & Node.  
  ...
  {/* Resume Button with slide animation */}
  <a
  ...
  {/* Projects Button with bounce effect */}
  <a
    href="#projects"
  ...
  >
    ...
    <span className="transform transition-transform duration-300 group-hover:-translate-y-0.5">↗</span>
      ...
      {/* Right Image with Blob + Animation */}
      <motion.div
